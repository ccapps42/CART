...
\midrule
768 & 6  & 6 & 3.010 & 22.85 & 23.15 & \multirow{3}{*}{\tbd{}} & \multirow{3}{*}{\tbd{}} & \multirow{3}{*}{\tbd{}} & Complete \\
768 & 8  & 6 & 3.023 & 22.86 & 23.30 &  &  &  & Complete \\
768 & 10 & 6 & 3.024 & 22.96 & 23.38 &  &  &  & Complete \\
\midrule
1024 & 6  & 6 & 2.798 & 20.35 & 20.67 & \multirow{3}{*}{\tbd{}} & \multirow{3}{*}{\tbd{}} & \multirow{3}{*}{\tbd{}} & Complete \\
...
\begin{enumerate}[leftmargin=*, topsep=2pt, itemsep=1pt]
  \item Across 36 fully-trained Stage 2 configurations, the LTI gate settles in the narrow band $\varrho \in [0.79, 0.83]$, with $\varrho$ rising monotonically with both $d$ (+0.033 from $d{=}256$ to $d{=}1024$ at $R{=}6$) and weakly with $R$ (+0.008 to +0.009 per pair of loops). The earlier ``universal $\varrho \approx 0.893$'' reported from Stage 1 at step 3{,}000 was a transient: $\varrho$ continues to decay through full training.
  \item Prelude depth $P$ dominates loop count $R$ in every condition tested ($P{=}6 > P{=}4 > P{=}3 > P{=}2$ holds without exception).
  \item At Stage 1 (3{,}000 steps), the benefit of recurrence depth appeared to grow monotonically with model width, from $-0.25\%$ at $d{=}256$ to $+5.24\%$ at $d{=}1024$ ($R{=}2 \to R{=}8$ on \pplwiki). At Stage 2 (30{,}500 steps, $\sim 10\times$ the tokens), this trend reverses: $R{=}6$ is the best $R$ at every scale $d \geq 512$, and going to $R{=}10$ regresses by up to $1\%$. Whether further training restores R-benefit is the subject of the planned extended-training experiment.
...
Parameter-matched Dense baselines at $d{=}1024$ (both stored-matched and effective-matched variants) and the P=4 R=10 d=1024 ablation testing whether prelude depth dominates loop count are running at the time of this preprint and will update the relevant tables and discussion upon completion.
