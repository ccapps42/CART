...
\midrule
 ...
 768 & \tbd{} & \tbd{} & \tbd{} & \tbd{} & \tbd{} & \tbd{} \\
1024 & \tbd{} & \tbd{} & \tbd{} & \tbd{} & \tbd{} & \tbd{} \\
\bottomrule
\end{tabular}
\end{table}

These four benchmarks together cover commonsense reasoning, scientific factual recall, long-range linguistic coherence, and physical-world plausibility---the dimensions on which a small language model's competence is most informatively measured. Reference: GPT-2 small (124M) achieves $\sim 29\%$ HellaSwag, $\sim 22\%$ ARC-C, $\sim 46\%$ LAMBADA accuracy, $\sim 62\%$ PIQA at this parameter scale. Our $d{=}1024$ configurations have $\sim 180$--$220$M effective parameters and a smaller token budget; we expect benchmark accuracies in a similar range, with the central comparison being CART-vs-Dense at parameter parity rather than CART-vs-published-models.
